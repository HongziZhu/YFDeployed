  ...
  render: function () {
    ...
    return (
      ...
      <h2>Writing Classes</h2>
        {wrData.grades.indexOf(self.state.incomingGrade) > -1 ? <WritingElective summerCampWeeks={this.state.summerCampWeeks} incomingGrade={this.state.incomingGrade}/> : <p></p>}
